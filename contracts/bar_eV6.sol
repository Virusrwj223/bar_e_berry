...
contract master {
    ...
    function earlyTerminateRental(address externaladdress, uint sharesTaken) public {
        ...
        if (remainingShareBal == 0){
            ...
            personToRenter[externaladdress][externaladdress].rentalDeposit=0;
        }else{
            personToRenter[externaladdress][externaladdress].depositAmount-=overdueBalance;
            personToRenter[personToRenter[externaladdress][externaladdress].lWalletAddress][personToRenter[externaladdress][externaladdress].lWalletAddress].depositAmount+=overdueBalance;
            personToRenter[externaladdress][externaladdress].hasRentPaid=true;
            ...
            uint256 oldDepositAmt = personToRenter[externaladdress][externaladdress].rentalDeposit;
            uint256 newDepositAmt = personToRenter[externaladdress][externaladdress].rentalDeposit*remainingShareBal/personToRenter[externaladdress][externaladdress].holdingShares;
            uint256 returningDepositAmt = oldDepositAmt - newDepositAmt;
            personToRenter[personToRenter[externaladdress][externaladdress].lWalletAddress][personToRenter[externaladdress][externaladdress].lWalletAddress].depositAmount-=returningDepositAmt;
            personToRenter[externaladdress][externaladdress].depositAmount+=returningDepositAmt;
            personToRenter[externaladdress][externaladdress].rentalDeposit = newDepositAmt;
